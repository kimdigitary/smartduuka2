    ...
    public function run(): void
    {
        Tenant::all()->runForEach(function (Tenant $tenant) {
            ...
            $expiry_date = match ($tenant->id) {
                'glowcitybeauty', 'ajmalcollections', 'oaklandpeakltd', 'timzclassic', 'jibinicreamaries' => '2026-06-16 23:59:59',
                'techpulsespares', 'zakayoproduce', 'digivolvetech', 'demoshop' => '2027-03-16 23:59:59',
