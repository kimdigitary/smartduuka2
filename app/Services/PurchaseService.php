<?php
    ...
    class PurchaseService
    {
                ...
                DB::transaction( function () use ($request) {
                    ...
                    if ( $request->items ) {
                        ...
                        foreach ( $products as $product ) {
                            ...
                            $this->upsertRetailPrices( $productModel , $product , $branch_id );
                            $this->upsertWholesalePrices( $productModel , $product , $branch_id );
            ...
            try {
                DB::transaction( function () use ($request , $purchase) {
                    ...
                    $expenseCategory = ExpenseCategory::firstOrCreate(
                        [ 'name' => 'Expense Category' , 'branch_id' => $branch_id , ] ,
         ...
         */
        private function upsertRetailPrices(Product $productModel , array $product , $branch_id) : void
        {
         ...
         */
        private function upsertWholesalePrices(Product $productModel , array $product , $branch_id) : void
        {
